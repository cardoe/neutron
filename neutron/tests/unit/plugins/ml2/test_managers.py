...
class TestMechManager(base.BaseTestCase):
    ...
    def test_delete_port_precommit_reverse_order(self):
        """delete_port_precommit must notify drivers in reverse (FILO) order."""
    ...
    def test_delete_port_postcommit_reverse_order(self):
        """delete_port_postcommit must notify drivers in reverse (FILO) order."""
        self._set_two_drivers()
        call_order = []
    ...
    def test_create_port_postcommit_forward_order(self):
        """create_port_postcommit must notify drivers in forward (FIFO) order."""
        self._set_two_drivers()
        call_order = []
